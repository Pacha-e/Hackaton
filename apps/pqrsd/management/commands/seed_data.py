...
PQRSDS_PRUEBA = [
    ...
    },
    {
        "tipo": "peticion",
        "canal_entrada": "web",
        "nombre_ciudadano": "Test SLA Alerta",
        "email_ciudadano": "alerta@test.com",
        "telefono_ciudadano": "3000000000",
        "documento_ciudadano": "0",
        "comuna": "Prueba",
        "barrio": "Prueba",
        "asunto": "Prueba de estado alerta (TEST)",
        "descripcion": "Verificar alertas dashboard",
        "prioridad": "alta",
        "estado": "clasificada",
        "dep_sigla": "EDU",
        "clasificacion_validada": True,
    ...
    },
    {
        "tipo": "queja",
        "canal_entrada": "email",
        "nombre_ciudadano": "Test SLA Vencida",
        "email_ciudadano": "vencida@test.com",
        "telefono_ciudadano": "3000000001",
        "documento_ciudadano": "1",
        "comuna": "Prueba 2",
        "barrio": "Prueba 2",
        "asunto": "Prueba estado vencida (TEST)",
        "descripcion": "Verificar estado vencido",
        "prioridad": "urgente",
        "estado": "en_tramite",
        "dep_sigla": "SSPM",
        "clasificacion_validada": True,
